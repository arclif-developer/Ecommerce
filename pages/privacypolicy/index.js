        ...
        <div className={styles.main_outer_cover}>
          ...
          <div className={styles.main_inner}>
            <div className={styles.termsContainer}>
              ...
              <p>
                <a href="https://agriha.arclif.com">https://agriha.arclif.com</a>
                website is owned by Arclif Technologies Pvt. Ltd., which is a data controller of your personal data.
              </p>
              <p>
                We have adopted this Privacy Policy, which determines how we are processing the information collected by{" "}
                <a href="https://agriha.arclif.com">https://agriha.arclif.com</a>, which also provides the reasons why
                we must collect certain personal data about you. Therefore, you must read this Privacy Policy before
                using <a href="https://agriha.arclif.com">https://agriha.arclif.com</a> website.
              </p>
              ...
              <p>
                When you visit the <a href="https://agriha.arclif.com">https://agriha.arclif.com</a>, we automatically
                collect certain information about your device, including information about your web browser, IP address,
                time zone, and some of the installed cookies on your device. Additionally, as you browse the Site, we
                collect information about the individual web pages or products you view, what websites or search terms
                referred you to the Site, and how you interact with the Site. We refer to this automatically-collected
                information as “Device Information.” Moreover, we might collect the personal data you provide to us
                (including but not limited to Name, Surname, Address, payment information, etc.) during registration to
                be able to fulfill the agreement.
              </p>
              <h5>Why do we process your data?</h5>
              <p>
                Our top priority is customer data security, and, as such, we may process only minimal user data, only as
                much as it is absolutely necessary to maintain the website. Information collected automatically is used
                only to identify potential cases of abuse and establish statistical information regarding website usage.
                This statistical information is not otherwise aggregated in such a way that it would identify any
              ...
              <p>
                ...
                information might be transferred outside of Europe, including Canada and the United States.
              </p>
              <h5>Links to other websites:</h5>
              <p>
                Our website may contain links to other websites that are not owned or controlled by us. Please be aware
              ...
              <p>
                ...
                safeguards to protect against unauthorized access, use, modification, and personal data disclosure in
                its control and custody. However, no data transmission over the Internet or wireless network can be
                guaranteed.
              </p>
              ...
              <p>
                ...
                <a href="mailto:support@arclif.com">support@arclif.com.</a>
              </p>
            </div>
          </div>
          <Help />
